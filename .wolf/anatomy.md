...
- `CLAUDE.md` — System Instructions: Thin Harness, Fat Skills Environment (~4203 tok)
...
- `test-bootstrap-caching.mjs` — originalExistsSync: isBootstrapSkillPath, makeOutput, countBootstrapParts + 3 more (~1396 tok)
- `test-bootstrap-caching.sh` — Test: Bootstrap Content Caching (#1202) (~303 tok)
- `test-plugin-loading.sh` — Test: Plugin Loading (~740 tok)
