...
| Need v1's exact prior behavior for a project that already depends on it | `design-taste-frontend-v1` | Only for backward-compat; `design-taste-frontend` (v2) is the standing default otherwise. |
